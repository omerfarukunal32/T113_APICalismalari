...
public class C26_Post_Pojo extends HerokuAppBaseURL {
    ...
    public void post01(){
        ...
        Response response = given().spec(specHerokuApp)  // given 'dan sonra pre-Condition ' lari yaziyoruz
                    .contentType(ContentType.JSON)
                .when()                                 // when() ' den sonra request ile ilgili komutlari yaziyoruz
                    .body(reqBody)
                    .post("/{pp1}");
        ...
        assertEquals(expData.getBookingid(), respPojo.getBookingid());
